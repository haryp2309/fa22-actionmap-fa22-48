...
Rails.application.routes.draw do
  ...
  get '/my_news_item/new' => 'my_news_items#new',
      :as                 => :new_my_news_item
  match '/my_news_item/new' => 'my_news_items#search',
        :as                 => :search_my_news_item,
        :via                => %i[put patch]
  post '/my_news_item/new', to: 'my_news_items#create', as: :create_my_news_item
  resources :representatives do
    resources :news_items, only: %i[index show]

    get '/my_news_item/:id' => 'my_news_items#edit',
        :as                 => :edit_my_news_item
    match '/my_news_item/:id' => 'my_news_items#update',
          :via                => %i[put patch]

    delete '/my_news_item/:id' => 'my_news_items#destroy'
  end
